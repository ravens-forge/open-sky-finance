...
lib/
  ...
  data/
    ...
    repositories/           # validation, invariants, transactions
  services/
...
- Aggregations (balances, totals) are computed in SQL inside DAOs, not by loading all rows
  into Dart.
...
| DAOs / repos  | unit          | In-memory Drift database |
